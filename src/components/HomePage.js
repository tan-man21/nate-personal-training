        ...
        <Container>
            <Row className="about-me-row">
                <Col md={6} className="about-me-text-col" data-aos="fade-right">
                    <h2>About Me</h2>
                    <p>At the start of his fitness journey, Personal weighed just 119 pounds, with little knowledge or direction regarding how to maximize his health, function, and performance. Fast forward a few years, and under the guidance of various trainers, Nate went on to place 1st in two separate Classic Physique bodybuilding competitions.</p>
                ...
                <Col md={6} className="about-me-image-col" data-aos="fade-left">
                    <Image src={"./assets/headshot.jpg"} alt="About preview" className="about-me-image" />
                </Col>
            </Row>
        </Container>
    </div>
